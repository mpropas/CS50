...
{
    //make google latlng object 
    var latLng = new google.maps.LatLng(place.latitude, place.longitude);
    
    //make google marker object as per documentation 
    ...
    $.getJSON("/articles?geo=" + place.postal_code, function (data) {
        //setup an event listener on success
        google.maps.event.addListener(marker,'click', function() {
        var result = "<ul>";
        //just get 5 results 10 is too much
        for(var i = 0; i < 5; i++) {
            result += "<li><a href='" + data[i]["link"] + "'>" + data[i]["title"] + "</a></li>";
        }
        result += "</ul>";
        //send html to showInfo
